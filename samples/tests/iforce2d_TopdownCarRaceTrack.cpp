...
public:
    ...
    void Step(Settings& settings)
    {
        ...
        //g_debugDraw.DrawString(5, m_textLine, "Tire traction: %.2f", m_tire->m_currentTraction);
        //m_textLine += 15;
    }
...
static int testIndex = RegisterTest("iforce2d", "TopdownCar", iforce2d_TopdownCar::Create);
#endif